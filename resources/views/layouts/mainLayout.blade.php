                    ...
                    <div class="dropdown show mr-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                            <ul class="list-unstyled m-0 p-0" >
                                <div style="max-height: 250px;overflow: auto;width:200px">
                                ...
                                <button class="btn btn-light text-primarycontainer-fluid">
                                    <a class="text-center pl-4" href="{{ route('messages.list') }}">Show all messages</a>
                                </button>
                            </ul>
                        </div>
