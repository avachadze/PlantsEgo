...
@section('languages')
<a class="dropdown-item" href="/en/register">{{__('messages.english')}}</a>
<a class="dropdown-item" href="/es/register">{{__('messages.spanish')}}</a>
<a class="dropdown-item" href="/eu/register">{{__('messages.basque')}}</a>
@endsection
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register', app()->getLocale()) }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('messages.registerName') }}</label>
