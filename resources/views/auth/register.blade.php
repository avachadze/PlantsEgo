            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="emailC" class=" col-form-label text-md-right">{{ __('auth.email') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class=" col-form-label text-md-right">{{ __('passwords.password') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class=" col-form-label text-md-right">{{ __('passwords.confirm') }}</label>
                        ...
                        <div class="form-group row justify-content-around">
                            <i id="clearRegister" class="fa fa-repeat fa-lg fa-fw" aria-hidden="true"></i>
                            <div class="inputWithIcon">
